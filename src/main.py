...
class CSV:
    CSV_FILE= "C:\\Labs\\PersonalFinanceTracker\\finance.csv"
...
def add():
    CSV.initialise_csv()
    date = get_date("Enter the date of the transaction  (dd-mm-yyyy) or press enter for today' date: ",allow_default=True)
    amount= get_amount()
...
def main():
    while True:
        print("\n 1. Add a new Trasactions")
        print(" 2. View  Trasactions with date range")
        print("3.Exit")
